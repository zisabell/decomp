...
# cld(lsmeans(models$ph_kcl,~ landuse, adjust="sidak"), Letters = c(letters))
# emm <- emmeans(models$ph_kcl, specs = pairwise ~ landuse)
# emm$contrasts
...
# cld(lsmeans(models$moisture_percentage,~ landuse, adjust="tukey"), 
# Letters = c(letters))
...
# Log transformation
var_log_N <- leveneTest(log(NO2_NO3_mg_kg) ~ landuse * location, data=mt_4)
