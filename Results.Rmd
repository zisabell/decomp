...
# Three-way ANOVA
threeway.lmeFit <- lmerTest::lmer(litter_mass_loss_final ~ landuse * litter_sp * mesh_size + (1|location/landuse),data=lml_2, 
                      na.action = "na.omit")
...
threeway_aov <- aov(litter_mass_loss_final ~ landuse * litter_sp * mesh_size + (1:location/landuse), data=lml_2, na.action = "na.omit")
...
fviz_pca_biplot(pca, label="var", habillage=mt_4_pca_nomiss$loc_lu, palette = "Paired", pointshape=16)  + xlim(-4,4) + ylim(-4,4)
...
fviz_pca_biplot(pca_2, label="var",habillage=mt_4$loc_lu, palette = "Paired", pointshape=16) + xlim(-4,4) + ylim(-4,4)
...
fviz_pca_biplot(pca_3, label="var", habillage=mr_alder_pca_nomiss$loc_lu, palette = "Paired", pointshape=16)  + xlim(-4,4) + ylim(-4,4)
