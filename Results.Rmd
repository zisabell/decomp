...
## Litter mass loss data - overall

``` {r plot, boxplot litter mass loss, fig.dim = c(10,8)}
...
shapiro.test(residuals(threeway.lmeFit)) # not significant (so normal)
hist(residuals(threeway.lmeFit)) # kind of looks like a normal distribution
...
## Litter mass loss data - per litter species
...
hist(residuals(litter_mesh.lmeFit))
