...
fviz_pca_biplot(pca, label="var", habillage=mt_4_pca_nomiss$loc_lu, palette = "Paired", pointshape=16)  + xlim(-4,4) + ylim(-4,4)  + theme(legend.position="bottom",text = element_text(size = 17))
...
fviz_pca_ind(pca_2, label="none", habillage=mt_4$loc_lu,
             addEllipses=TRUE, ellipse.level=0.95, , palette = "Paired", pointshape=16)

fviz_pca_ind(pca_2, label="none", habillage=mt_4$loc_lu, palette = "Paired", pointshape=16)

fviz_pca_biplot(pca_2, label="var",habillage=mt_4$loc_lu, palette = "Paired", pointshape=16) + xlim(-4,4) + ylim(-4,4) + theme(legend.position="bottom", ,text = element_text(size = 17))
...
fviz_pca_ind(pca_3, label="none", habillage=mr_alder_pca_nomiss$loc_lu, palette = "Paired", pointshape=16)  + xlim(-4,4) + ylim(-4,4)

fviz_pca_biplot(pca_3, label="var", habillage=mr_alder_pca_nomiss$loc_lu, palette = "Paired", pointshape=16)  + xlim(-4,4) + ylim(-4,4) + theme(legend.position="bottom",text = element_text(size = 17))
