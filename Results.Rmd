...
mt_4_pca <- mt_4 %>% dplyr::select(c(landuse,location,loc_lu,ph_kcl,moisture_percentage,som_percentage,
                                     b.d., NO2_NO3_mg_kg,
                                     NH4_mg_kg,Total_P_mg_kg,Olsen_P_mg_kg,
...
fviz_pca_biplot(pca, label="var", habillage=mt_4_pca_nomiss$loc_lu, palette = "Paired", pointshape=16, mean.point = FALSE)  + xlim(-4,4) + ylim(-4,4) + theme(legend.position="bottom",text = element_text(size = 17))
...
mt_4_pca_big <- mt_4 %>% dplyr::select(c(ph_kcl,moisture_percentage,som_percentage, b.d., NO2_NO3_mg_kg,
...
fviz_pca_ind(pca_2, label="none", habillage=mt_4$loc_lu, palette = "Paired", pointshape=16, mean.point = FALSE)

fviz_pca_biplot(pca_2, label="var",habillage=mt_4$loc_lu, palette = "Paired", pointshape=16, mean.point = FALSE) + xlim(-4,4) + ylim(-4,4) + theme(legend.position="bottom", ,text = element_text(size = 17))
